...
towns["Far Away"] = Town((0, -80, 80), 4883, {"timber": 2}, {"shipwright": 1})

# todo put in alllll the other references in the world as part of Far Away; then add allll the world's production in HexResources.py


towns["Guroff"] = Town((47, -63, 16), 2382, {"clay": 1, "iron ore": 2}, {"potter": 1})
towns["Nender"] = Town(
    (48, -66, 18), 1000, {"coal": 1, "tin ore": 1, "iron ore": 1}, {"tinsmith": 1}
)
towns["Pwodd"] = Town(
    (49, -65, 16),
    1000,
...
towns["Fulgarri"] = Town(
    (47, -59, 12), 1500, {"copper ore": 1, "lead ore": 1}, {"coppersmith": 1}
)
towns["Widder"] = Town(
    (49, -63, 14), 1162, {"nickel ore": 1, "manganese ore": 2}, {"blacksmith": 2}
)
towns["Yog"] = Town(
    (45, -60, 15),
    1703,
...
towns["Jiu Qia"] = Town((38, -70, 32), 1890, {"cinnabar": 1}, {"locksmith": 1})
...
addConnection("Veder Vek", "Far Away")
