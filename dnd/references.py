...
world_references = {
    ...
    "wood, African oak": {"references": 1, "category": "timber"},
    "wood, aspen": {"references": 1, "category": "timber"},
    "wood, bamboo": {"references": 8},
    "wood, beech": {"references": 7, "category": "timber"},
    "wood, birch": {"references": 2, "category": "timber"},
    "wood, boxwood": {"references": 2, "category": "timber"},
    "wood, carobwood": {"references": 1, "category": "timber"},
    "wood, cedar": {"references": 6, "category": "timber"},
    "wood, chestnut": {"references": 15, "category": "timber"},
    "wood, cork": {"references": 38},
    "wood, cypress": {"references": 2, "category": "timber"},
    "wood, eucalyptus": {"references": 1},
    "wood, fir": {"references": 7},
    "wood, hornbeam": {"references": 1, "category": "timber"},
    "wood, iroko": {"references": 1, "category": "timber"},
    "wood, ironwood": {"references": 4, "category": "timber"},
    "wood, jelutong": {"references": 1, "category": "timber"},
